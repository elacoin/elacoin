...
void ThreadSocketHandler2(void* parg)
{
    ...
    loop
    {
        ...
        if (hListenSocket != INVALID_SOCKET && FD_ISSET(hListenSocket, &fdsetRecv))
        {
            ...
            else if (nInbound >= GetArg("-maxconnections", 1000) - MAX_OUTBOUND_CONNECTIONS)
            {
                {
...
void ThreadOpenConnections2(void* parg)
{
    ...
    loop
    {
        ...
        loop
        {
            ...
            CAddress addr = addrman.Select(10 + min(nOutbound,200)*10);
...
void StartNode(void* parg)
{
    ...
    if (semOutbound == NULL) {
        ...
        int nMaxOutbound = min(MAX_OUTBOUND_CONNECTIONS, (int)GetArg("-maxconnections", 1000));
